...
def process_query_sysu(data_path, mode = 'all', relabel=False):
    if mode== 'all':
        ...
        ir_cameras = ['cam3','cam6']
    data_path_ori = '/media/fzl/f7f9753e-5f42-4b38-afec-3b09022de951/song/crossReid/dataSets/SYSU-MM01/'
    data_path = '/media/fzl/f7f9753e-5f42-4b38-afec-3b09022de951/song/crossReid/dataSets/SYSU_MM01_SHAPE/'
